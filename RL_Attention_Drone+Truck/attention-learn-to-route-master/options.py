...
def get_options(args=None):
    ...
    parser.add_argument('--batch_size', type=int, default=128, help='Number of instances per batch during training')###############512
    parser.add_argument('--epoch_size', type=int, default=64000, help='Number of instances per epoch during training')##############1280000
    ...
    parser.add_argument('--max_grad_norm', type=float, default=1.0,
                        help='Maximum L2 norm for gradient clippng, default 1.0 (0 to disable clipping)')
    ...
    parser.add_argument('--checkpoint_epochs', type=int, default=1,
                        help='Save checkpoint every n epochs (default 1), 0 to save no checkpoints')##################1
